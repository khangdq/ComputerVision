...
st.write("## Object Detection/ Segmentation")
...
if choice == '1. Introduction':
    ...
    st.info("### Business Objective/Problem")
    st.markdown("""- Our earth is increasingly seriously polluted, garbage is overflowing all over the planet but only a small amount is recycled.
- The problem is how to increase the amount of garbage waste recycled and segregate them     

-> Build models for detecting and classifying waste to help robots collect and classify garbage to send to recycling places""")
    st.success("Within the scope of this project: focus on 4 types of solid waste: Glass, Metal, Paper & Plastic")
    st.info("### Requirement")
    st.markdown("""- Project 1: Build a model of waste classification solid types (glass, metal, paper, plastic). (Object Classification)
- Project 2: Build a model to detect objects solid waste. (Object Detection & Object Segmentation)""")
elif choice == '2. Model':
    st.write("## 2. Model")
    st.info("### Object Classification")
    col7,col8=st.columns(2)
    with col7:
        st.warning("CNN model")
        st.write("Confusion matrix")
        st.image(Image.open('Images/CNN.png'))
        st.image(Image.open('Images/CNN2.png'))
    with col8:
        st.warning("Pretrain model")
        st.write("Confusion matrix")
        st.image(Image.open('Images/PreTrain.png'))
        st.image(Image.open('Images/PreTrain2.png'))
    st.success("PreTrained model has a better result => Choose PreTrained model (mobilenet)")
    st.info("### Object Detection/ Segmentation")
    col9,col10=st.columns(2)
    with col9:
        st.warning("Object Detection")
        st.write("Confusion matrix")
        st.image(Image.open('Images/det.png'))
        st.image(Image.open('Images/DetBoxF1_curve.png'))
        st.image(Image.open('Images/DetBoxPR_curve.png'))
    with col10:
        st.warning("Object Segmentation")
        st.write("Confusion matrix")
        st.image(Image.open('Images/seg.png'))
        st.image(Image.open('Images/SegBoxF1_curve.png'))
        st.image(Image.open('Images/SegBoxPR_curve.png'))
